...
public class Populator implements CommandLineRunner {
    ...
    public Populator(TopicRepository topicRepo, PostRepository postRepo, HashtagRepo hashtagRepo) {
    ...
    public void run(String... args) throws Exception {
        Hashtag hashtag1 = new Hashtag("boring","bedtime stories by ben s");
        Hashtag hashtag2 = new Hashtag("long","who  blogs a dictionary");
        Hashtag hashtag3 = new Hashtag("easyToRead","Stuff for the little ones");
        ...
        Post post1 = new Post("TDD For Fun and Profit", topic1, "Lorem ipsum dolor sit amet, consectetur " +
                ...
                "est laborum.","bill Nye",hashtag1,hashtag2);
        postRepo.save(post1);
        Post post2 = new Post("Test the Fear Away", topic1, "Lorem ipsum dolor sit amet, consectetur " +
                ...
                "aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. " +
                "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id " +
                "est laborum.","Rick Sanchez",hashtag2,hashtag3);
        postRepo.save(post2);
        Post post3 = new Post("Unit Tests and You", topic1, "Lorem ipsum dolor sit amet, consectetur " +
                ...
                "aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. " +
                "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id " +
                "est laborum.","Summer Smith",hashtag1,hashtag3);
        postRepo.save(post3);
